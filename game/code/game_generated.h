...
{
    {0, MetaType_v3, "OffsetP", (u64)&((sim_entity_collision_volume *)0)->OffsetP},
    {0, MetaType_v3, "Dim", (u64)&((sim_entity_collision_volume *)0)->Dim},
};
...
{
    {0, MetaType_v2, "Min", (u64)&((rectangle2 *)0)->Min},
    {0, MetaType_v2, "Max", (u64)&((rectangle2 *)0)->Max},
};
member_definition MembersOf_rectangle3[] = 
{
    {0, MetaType_v3, "Min", (u64)&((rectangle3 *)0)->Min},
    {0, MetaType_v3, "Max", (u64)&((rectangle3 *)0)->Max},
};
